...
from .views import ClassListCreateView, ClassDetailView, SessionListCreateView, SessionDetailView
...
urlpatterns = [
    ...
    path('token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),  # Thêm dòng này
